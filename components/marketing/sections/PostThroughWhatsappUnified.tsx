...
export function PostThroughWhatsappUnified(): React.ReactElement {
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          >
            ...
            >
              <div className="relative w-full bg-[#0c0e14] p-1 sm:p-1.5">
                <Image
                  src={marketingImageWhatsapp}
                  alt={t("marketing.whatsappImageAlt")}
                  width={marketingImageWhatsapp.width}
                  height={marketingImageWhatsapp.height}
          ...
          >
            <motion.p
              variants={fadeUp}
              custom={0}
              className="text-xs font-black uppercase tracking-[0.28em] text-[#25D366]"
            >
              {t("marketing.whatsappEyebrow")}
            </motion.p>
            <motion.h2
              variants={fadeUp}
              custom={1}
