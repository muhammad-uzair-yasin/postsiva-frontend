...
export function ComposeWithPreviewUnified(): React.ReactElement {
  ...
  return (
    ...
    >
      <div className="marketing-section-aurora pointer-events-none absolute inset-0 opacity-42" />
      <div className="marketing-container">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            >
              <div className="relative w-full bg-[#0c0e14] p-1 sm:p-1.5">
                <Image
                  ...
                  width={marketingImageComposeWithPreview.width}
                  height={marketingImageComposeWithPreview.height}
          ...
          >
            ...
            >
              {t("marketing.composePreviewEyebrow")}
            </motion.p>
            <motion.h2
              variants={fadeUp}
              custom={1}
            ...
            >
              {t("marketing.composePreviewTitlePrefix")}{" "}
              <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                {t("marketing.composePreviewTitleAccent")}
              </span>
            </motion.h2>
            <motion.p
              variants={fadeUp}
            ...
            >
              {t("marketing.composePreviewBody")}
            </motion.p>
          </motion.div>
        </div>
      </div>
